...
export default function LoadingScreen() {
  ...
  return (
    ...
    >
      ...
      >
        <motion.div
          className="absolute w-64 h-64 rounded-full border border-cyan-400/50 blur-[2px]"
        ...
        >
          <Image
            ...
            width={90}
            height={90}
            className="drop-shadow-[0_0_20px_rgba(0,255,255,0.7)]"
          />
        </motion.div>
        ...
        <motion.p
          className="mt-10 text-2xl sm:text-3xl font-semibold tracking-wider text-center"
        ...
        <motion.span
          className="text-sm sm:text-base mt-3 tracking-widest text-black font-semibold drop-shadow-[0_0_10px_rgba(0,0,0,0.7)] uppercase"
